...
#define PLUG_NAME "IPlugControlsDemo"

// No quotes or spaces.
#define PLUG_CLASS_NAME IPlugControlsDemo
...
#define BUNDLE_NAME "IPlugControlsDemo"
...
// No quotes or spaces.
#define PLUG_ENTRY IPlugControlsDemo_Entry
#define PLUG_VIEW_ENTRY IPlugControlsDemo_ViewEntry

// The same strings, with double quotes.  There's no other way, trust me.
#define PLUG_ENTRY_STR "IPlugControlsDemo_Entry"
#define PLUG_VIEW_ENTRY_STR "IPlugControlsDemo_ViewEntry"

// This is the exported cocoa view class, some hosts display this string.
// No quotes or spaces.
#define VIEW_CLASS IPlugControlsDemo_View
#define VIEW_CLASS_STR "IPlugControlsDemo_View"
