...
// No quotes or spaces.
#define PLUG_ENTRY IPlugMidiEffect_Entry
#define PLUG_VIEW_ENTRY IPlugMidiEffect_ViewEntry

// The same strings, with double quotes.  There's no other way, trust me.
#define PLUG_ENTRY_STR "IPlugMidiEffect_Entry"
#define PLUG_VIEW_ENTRY_STR "IPlugMidiEffect_ViewEntry"

// This is the exported cocoa view class, some hosts display this string.
// No quotes or spaces.
#define VIEW_CLASS IPlugMidiEffect_View
#define VIEW_CLASS_STR "IPlugMidiEffect_View"
