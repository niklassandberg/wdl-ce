...
IPlugVerbEngine::IPlugVerbEngine(IPlugInstanceInfo instanceInfo):
...
void IPlugVerbEngine::OnParamChange(int paramIdx)
{
...
void IPlugVerbEngine::ProcessDoubleReplacing(double** inputs, double** outputs, int nFrames)
{
	if (mDry == 0. && mWet == 1.)
	{
